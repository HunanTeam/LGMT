...
namespace Nop.Core.Domain.Catalog
{
    ...
    public partial class Product : BaseEntity, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported
    {
        ...
        private ICollection<ProductGroupProduct> _productGroupProducts;
        ...
        /// Gets or sets the product tags
        /// </summary>
        public virtual ICollection<ProductGroupProduct> ProductGroupProducts
        {
            get { return _productGroupProducts ?? (_productGroupProducts = new List<ProductGroupProduct>()); }
            protected set { _productGroupProducts = value; }
        }
