...
namespace Nop.Core.Domain.Orders
{
    ...
    public partial class Order : BaseEntity
    {
        ...
        private ICollection<OrderLiveScene> _orderLiveScenes;
        ...
        public string OrderDepositPaymentMethod { get; set; }
        public DateTime? OrderDepositPaymentDateUtc { get; set; }
        /// <summary>
        /// 订单尾款
        /// </summary>
        public decimal? OrderBalance { get; set; }
        public int? OrderBalancePaymentStatus { get; set; }
        public string OrderBalancePaymentMethod { get; set; }
        public DateTime? OrderBalancePaymentDateUtc { get; set; }
        ...
        public virtual ICollection<OrderLiveScene> OrderLiveScenes
        {
            get { return _orderLiveScenes ?? (_orderLiveScenes = new List<OrderLiveScene>()); }
            protected set { _orderLiveScenes = value; }
        }
