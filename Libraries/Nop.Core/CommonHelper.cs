...
namespace Nop.Core
{
    ...
    public partial class CommonHelper
    {
        ...
        public static bool IsValidPhone(string phone)
        {
            ...
            phone = phone.Trim();
            var result = Regex.IsMatch(phone, @"^[1]+[3,5,8,4,6,9]+\d{9}$", RegexOptions.IgnoreCase);
            return result;
        }
        ...
        public static byte[] GetRemotePictureBytes(string pictureUrl)
        {
            try
            {
                var wreq = System.Net.WebRequest.Create(pictureUrl);
                wreq.Timeout = 10000;
                var wresp = (System.Net.HttpWebResponse)wreq.GetResponse();
