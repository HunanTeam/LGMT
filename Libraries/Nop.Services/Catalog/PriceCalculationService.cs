    ...
    public partial class PriceCalculationService : IPriceCalculationService
    {
            ...
            out Discount appliedDiscount)
        {
            ...
            else
            {
                ...
                {
                    var tmpPrice = 0.00M; //最终售价
                    //foreach (var attributeValue in attributeValues)
                    //{
                    //    //attributesTotalPrice += GetProductAttributeValuePriceAdjustment(attributeValue);
                    //}

                    tmpPrice = CalculateUnitPrice(product, attributeValues.ToList());
                    attributesTotalPrice = tmpPrice - product.Price;
                }
        ...
        /// <returns></returns>
        private decimal CalculateUnitPrice(Product product, List<ProductAttributeValue> attributeValues)
        {
            ...
            {
                var priceChiCun = 0.00M;
                var pricePeiJian = 0.00M;
                var priceLianTou = 0.00M;

                var chiCunAttribute = attributeValues.FirstOrDefault(m => m.ProductAttributeMapping.ProductAttribute.Name == "尺寸");
                var guiDaoAttribute = attributeValues.FirstOrDefault(m => m.ProductAttributeMapping.ProductAttribute.Name == "轨道");
                var chuangShaAttribute = attributeValues.FirstOrDefault(m => m.ProductAttributeMapping.ProductAttribute.Name == "窗纱");
                var zheGuangAttribute = attributeValues.FirstOrDefault(m => m.ProductAttributeMapping.ProductAttribute.Name == "遮光布");
                var lianTouAttribute = attributeValues.FirstOrDefault(m => m.ProductAttributeMapping.ProductAttribute.Name == "帘头");
                //var lianTouAttribute = attributeValues.FirstOrDefault(m => m.ProductAttributeMapping.ProductAttribute.Name == "帘头");
                //var lianTouAttribute = attributeValues.FirstOrDefault(m => m.ProductAttributeMapping.ProductAttribute.Name == "帘头");
                if (chiCunAttribute != null)
                {
                    priceChiCun = chiCunAttribute.Price;
                        ...
                        case "S(180cm-200cm)":
                            {
                                ...
                                if (chuangShaAttribute != null)
                                    pricePeiJian = pricePeiJian + chuangShaAttribute.PriceS;
                                if (zheGuangAttribute != null)
                                    pricePeiJian = pricePeiJian + zheGuangAttribute.PriceS;

                                if (lianTouAttribute != null)
                                    priceLianTou = priceLianTou + lianTouAttribute.PriceS;
                        ...
                        case "M(200cm-300cm)":
                            {
                                ...
                                if (chuangShaAttribute != null)
                                    pricePeiJian = pricePeiJian + chuangShaAttribute.PriceM;
                                if (zheGuangAttribute != null)
                                    pricePeiJian = pricePeiJian + zheGuangAttribute.PriceM;

                                if (lianTouAttribute != null)
                                    priceLianTou = priceLianTou + lianTouAttribute.PriceM;
                        ...
                        case "L(300cm-360cm)":
                            {
                                ...
                                if (chuangShaAttribute != null)
                                    pricePeiJian = pricePeiJian + chuangShaAttribute.PriceX;
                                if (zheGuangAttribute != null)
                                    pricePeiJian = pricePeiJian + zheGuangAttribute.PriceX;

                                if (lianTouAttribute != null)
                                    priceLianTou = priceLianTou + lianTouAttribute.PriceX;
                        ...
                        case "XL(360cm-420cm)":
                            {
                                ...
                                if (chuangShaAttribute != null)
                                    pricePeiJian = pricePeiJian + chuangShaAttribute.PriceXL;
                                if (zheGuangAttribute != null)
                                    pricePeiJian = pricePeiJian + zheGuangAttribute.PriceXL;

                                if (lianTouAttribute != null)
                                    priceLianTou = priceLianTou + lianTouAttribute.PriceXL;
                ...
                unitPrice = priceChiCun + pricePeiJian + priceLianTou;
            }
            #endregion
