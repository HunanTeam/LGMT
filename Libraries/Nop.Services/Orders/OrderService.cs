...
namespace Nop.Services.Orders
{
    ...
    public partial class OrderService : IOrderService
    {
        ...
        private readonly IRepository<OrderLiveScene> _orderLiveSceneRepository;
        ...
        public OrderService(IRepository<Order> orderRepository,
            ...
            IRepository<OrderLiveScene> orderLiveSceneRepository,
            ...
            IEventPublisher eventPublisher)
        {
            ...
            this._orderLiveSceneRepository = orderLiveSceneRepository;
        ...
        public virtual Order GetOrderByOrderNumber(string orderNumber)
        {
            if (string.IsNullOrEmpty(orderNumber))
                return null;

            return _orderRepository.Table.FirstOrDefault(o => o.OrderNumber == orderNumber);
        }
        ...
        #region Orders live scene

        public virtual OrderLiveScene GetLiveSceneById(int liveSceneId)
        {
            if (liveSceneId == 0)
                return null;

            return _orderLiveSceneRepository.GetById(liveSceneId);
        }
        ...
        /// </summary>
        /// <param name="orderItem">The order item</param>
        public virtual void DeleteLiveScene(OrderLiveScene liveScene)
        {
            if (liveScene == null)
                throw new ArgumentNullException("liveScene");

            _orderLiveSceneRepository.Delete(liveScene);
        }

        public virtual void UpdateLiveScene(OrderLiveScene liveScene)
        {
            if (liveScene == null)
                throw new ArgumentNullException("liveScene");

            _orderLiveSceneRepository.Update(liveScene);
        }

        public virtual IList<OrderLiveScene> GetAllLiveScenes(int orderId)
        {
            var query = from orderLiveScene in _orderLiveSceneRepository.Table
                        where orderLiveScene.OrderId == orderId
                        select orderLiveScene;

            var orderLiveScenes = query.ToList();
