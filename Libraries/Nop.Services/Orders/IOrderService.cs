...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderService
    {
        ...
        OrderLiveScene GetLiveSceneById(int liveSceneId);
        void DeleteLiveScene(OrderLiveScene liveScene);
        void UpdateLiveScene(OrderLiveScene liveScene);
        IList<OrderLiveScene> GetAllLiveScenes(int orderId);
