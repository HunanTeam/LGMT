...
namespace Nop.Admin.Extensions
{
    public static class MappingExtensions
    {
        ...
        public static HomepageModuleModel ToModel(this HomepageModule entity)
        {
            var model = entity.MapTo<HomepageModule, HomepageModuleModel>();
            switch(model.ModuleType)
            {
                case 0:
                    model.ModuleTypeName = "轮播滚动广告"; break;
                case 5:
                    model.ModuleTypeName = "2*5张小图片"; break;
                case 10:
                    model.ModuleTypeName = "4张图片布局1"; break;
                case 11:
                    model.ModuleTypeName = "4张图片布局2"; break;
                case 12:
                    model.ModuleTypeName = "4张图片布局3"; break;
                case 13:
                    model.ModuleTypeName = "3张图片布局1"; break;
                case 14:
                    model.ModuleTypeName = "3张图片布局2"; break;
            }          
            return model;
        }

        public static HomepageModule ToEntity(this HomepageModuleModel model)
        {
            return model.MapTo<HomepageModuleModel, HomepageModule>();
        }

        public static HomepageModule ToEntity(this HomepageModuleModel model, HomepageModule destination)
        {
            return model.MapTo(destination);
        }
