...
namespace Nop.Web.Models.Order
{
    public partial class OrderDetailsModel : BaseNopEntityModel
    {
        public OrderDetailsModel()
        {
            ...
            Items1 = new List<OrderItemModel>();
            Items2 = new List<OrderItemModel>();
            Items3 = new List<OrderItemModel>();
            Items4 = new List<OrderItemModel>();
            OrderNotes = new List<OrderNote>();
            Shipments = new List<ShipmentBriefModel>();
            LiveScenes = new List<LiveSceneModel>();
        ...
        /// 订单定金
        /// </summary>
        public string OrderDeposit { get; set; }
        public int? OrderDepositPaymentStatus { get; set; }
        /// <summary>
        /// 订单尾款
        /// </summary>
        public string OrderBalance { get; set; }
        public int? OrderBalancePaymentStatus { get; set; }
        ...
        /// 窗帘
        /// </summary>
        public IList<OrderItemModel> Items1 { get; set; }
        /// <summary>
        /// 罗马杆
        /// </summary>
        public IList<OrderItemModel> Items2 { get; set; }
        /// <summary>
        /// 轨道
        /// </summary>
        public IList<OrderItemModel> Items3 { get; set; }
        /// <summary>
        /// 百叶窗
        /// </summary>
        public IList<OrderItemModel> Items4 { get; set; }

        public IList<LiveSceneModel> LiveScenes { get; set; }
        ...
        public class LiveSceneModel : BaseNopModel
        {
