...
namespace Com.Alipay
{
    ...
    public class AlipayConfig
    {
        ...
        public static string partner = "2088302754150111";
        ...
        public static string private_key = HttpRuntime.AppDomainAppPath.ToString() + "app_data\\alipay_key\\rsa_private_key.pem";

        //支付宝的公钥文件路径，查看地址：https://b.alipay.com/order/pidAndKey.htm 
        public static string alipay_public_key = HttpRuntime.AppDomainAppPath.ToString() + "app_data\\alipay_key\\alipay_public_key.pem";
