...
{
    public class PasswordRecoveryStep3Validator : AbstractValidator<PasswordRecoveryStep3Model>
    {
        public PasswordRecoveryStep3Validator(ILocalizationService localizationService, CustomerSettings customerSettings)
        {
